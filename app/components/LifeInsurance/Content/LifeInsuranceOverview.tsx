	...
	return (
		<Tab.Panel className="flex flex-col gap-4 text-lg">
			...
			<span>
				...
				pays a death benefit to your beneficiaries when you die1. The death
				benefit can be used for various expenses, such as bills, mortgage,
				college, or burial costs1. Life insurance can also provide peace of mind
			...
			<span>
				...
				permanent life insurance, which provides lifetime coverage1. Each type
