...
const WhyCard: React.FC<IWhyCard> = ({ alt, src, title, text }) => {
	return (
		<div className="flex w-full max-w-lg flex-col gap-2 rounded-lg border border-black border-opacity-30 bg-white p-6 transition-all hover:scale-110 lg:h-64 lg:w-80">
